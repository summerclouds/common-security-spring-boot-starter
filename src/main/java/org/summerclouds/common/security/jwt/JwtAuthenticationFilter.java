...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Creates an instance which will authenticate against the supplied {@code
     * AuthenticationManager} and which will ignore failed authentication attempts, allowing the
     * request to proceed down the filter chain.
     *
    ...
    /**
     * Creates an instance which will authenticate against the supplied {@code
     * AuthenticationManager} and use the supplied {@code AuthenticationEntryPoint} to handle
    ...
    public void afterPropertiesSet() {
        ...
        if (!isIgnoreFailure()) {
            Assert.notNull(
                    this.authenticationEntryPoint, "An AuthenticationEntryPoint is required");
        }
    }
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            this.logger.trace(
                    LogMessage.format(
                            "Found username '%s' in Basic Authorization header", username));
